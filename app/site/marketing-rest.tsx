...
export const faqs = [
 ['Was ist Your Story?', 'What is Your Story?', 'Ein interaktives Referenzprojekt: eine persönliche Geschichte als Browserspiel und ein Studio zum Sammeln eigener Geschichtenentwürfe. Die Demo erzählt die Geschichte für Luana in fünf Kapiteln.', 'An interactive portfolio project: a personal story as a browser game, plus a studio for collecting story drafts. The demo tells the story for Luana in five chapters.'],
